...
function matchCommitted(s,f){
  ...
  const x=s.achievementStats,season=x.seasons[s.season]||(x.seasons[s.season]={wins:0,derby:0,die:0,matches:0,losses:0,cleanSheets:0}),home=r.home===s.playerTeam,pg=home?n(r.homeGoals):n(r.awayGoals),og=home?n(r.awayGoals):n(r.homeGoals),outcome=pg>og?'win':pg===og?'draw':'loss';
