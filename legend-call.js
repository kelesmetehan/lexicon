...
.ll-legend-banner{position:relative;margin-top:13px;border-radius:14px;padding:16px;background:linear-gradient(135deg,#1b1030,#2a1650 45%,#401b52);border:1px solid rgba(232,200,112,.42);box-shadow:0 0 0 1px rgba(232,200,112,.05) inset,0 10px 30px rgba(124,58,237,.22);overflow:hidden;animation:llLegendBannerIn .65s cubic-bezier(.2,.9,.25,1.1) both}.ll-legend-banner::after{content:'';position:absolute;inset:-1px;border-radius:14px;padding:1px;background:linear-gradient(120deg,transparent,rgba(232,200,112,.9),transparent);background-size:250% 100%;-webkit-mask:linear-gradient(#000 0 0) content-box,linear-gradient(#000 0 0);-webkit-mask-composite:xor;mask-composite:exclude;animation:llLegendSheen 3.2s linear infinite;pointer-events:none}.ll-legend-tagrow{display:flex;align-items:center;gap:8px;margin-bottom:7px}.ll-legend-badge{font-size:9px;font-weight:900;letter-spacing:.1em;text-transform:uppercase;color:#1b1030;background:linear-gradient(135deg,#e8c870,#c9a84c);padding:4px 9px;border-radius:999px}.ll-legend-rare{font-size:10px;color:#aaa4b5}.ll-legend-title{font-family:'Cormorant Garamond',serif;font-size:25px;font-weight:600;color:#e8c870;margin-bottom:4px}.ll-legend-title .ll-legend-flame{display:inline-block;margin-right:8px;filter:drop-shadow(0 0 6px rgba(232,200,112,.7));animation:llLegendFlicker 2.4s ease-in-out infinite}.ll-legend-sub{font-size:12px;color:#b8b3c0;line-height:1.5}.ll-legend-sub b{color:#f8fafc}.ll-legend-actions{display:flex;gap:9px;flex-wrap:wrap;margin-top:13px}.ll-legend-actions .ll-btn{flex:1;min-width:150px}.ll-legend-accept{background:linear-gradient(135deg,#7c3aed,#c9a84c)!important;color:#160b28!important;border-color:transparent!important}.ll-legend-cine{--legend-glow:rgba(124,58,237,.22);position:relative;overflow:hidden;max-width:720px;margin:0 auto;padding:40px 24px 30px;text-align:center;border:1px solid rgba(201,168,76,.30);border-radius:20px;background:radial-gradient(ellipse at 50% 0,var(--legend-glow),transparent 60%),linear-gradient(180deg,#161b24,#0f1218);box-shadow:0 18px 55px rgba(0,0,0,.45)}.ll-legend-particles{position:absolute;inset:0;pointer-events:none}.ll-legend-particles i{position:absolute;left:50%;top:42%;width:6px;height:6px;border-radius:2px;background:#e8c870;opacity:0;animation:llLegendBurst var(--duration,1.2s) ease-out forwards;animation-delay:var(--delay,.45s)}.ll-legend-score{font-size:11px;letter-spacing:.14em;text-transform:uppercase;color:#9a9589;animation:llLegendFade .5s both}.ll-legend-score b{color:#e8c870;font-size:16px}.ll-legend-cine-icon{font-size:54px;margin:15px 0 5px;filter:drop-shadow(0 0 22px rgba(232,200,112,.55));animation:llLegendPop .7s cubic-bezier(.2,1.4,.4,1) .25s both}.ll-legend-cine-title{font-family:'Cormorant Garamond',serif;font-size:34px;font-weight:600;margin-bottom:8px;background:linear-gradient(135deg,#e8c870,#fff6e0,#c9a84c);background-size:200% auto;-webkit-background-clip:text;background-clip:text;color:transparent;animation:llLegendTitle .7s ease .4s both,llLegendShimmer 2.4s linear 1s infinite}.ll-legend-quote{font-size:13px;color:#aaa4b5;font-style:italic;margin-bottom:18px;animation:llLegendFade .6s .7s both}.ll-legend-reward{display:inline-flex;align-items:center;gap:10px;padding:12px 18px;border:1px solid rgba(201,168,76,.25);border-radius:12px;background:rgba(201,168,76,.12);animation:llLegendTitle .6s ease .9s both}.ll-legend-reward span{font-size:22px}.ll-legend-reward div{text-align:left;font-size:12px}.ll-legend-reward b{display:block;color:#e8c870;font-family:'Cormorant Garamond',serif;font-size:17px}.ll-legend-tier-note{margin:16px auto 0;max-width:600px;color:#94a3b8;font-size:11px}.ll-legend-choice{margin-top:19px}.ll-legend-sequence{margin:10px 0;padding:9px 11px;border:1px solid rgba(232,200,112,.38);border-radius:10px;background:rgba(124,58,237,.10);color:#d8d2df;font-size:11px}.ll-legend-match-badge{margin:12px 0;padding:11px 13px;border:1px solid rgba(232,200,112,.52);border-radius:11px;background:linear-gradient(135deg,rgba(124,58,237,.13),rgba(201,168,76,.08));font-size:12px}.ll-legend-memory-card{margin-top:14px}.ll-legend-memory-list{display:grid;gap:8px}.ll-legend-memory{padding:11px;border:1px solid rgba(201,168,76,.26);border-radius:11px;background:linear-gradient(135deg,rgba(201,168,76,.08),rgba(15,23,42,.35))}.ll-legend-memory b,.ll-legend-memory span,.ll-legend-memory small{display:block}.ll-legend-memory span,.ll-legend-memory small{font-size:11px;color:#94a3b8;margin-top:3px}@keyframes llLegendBannerIn{from{opacity:0;transform:translateY(14px) scale(.97)}to{opacity:1;transform:none}}@keyframes llLegendSheen{from{background-position:150% 0}to{background-position:-150% 0}}@keyframes llLegendFlicker{0%,100%{transform:scale(1)}30%{transform:scale(1.08) rotate(-3deg)}60%{transform:scale(.97) rotate(2deg)}}@keyframes llLegendFade{from{opacity:0}to{opacity:1}}@keyframes llLegendPop{from{opacity:0;transform:scale(.4) rotate(-15deg)}to{opacity:1;transform:scale(1)}}@keyframes llLegendTitle{from{opacity:0;transform:translateY(10px)}to{opacity:1;transform:none}}@keyframes llLegendShimmer{from{background-position:0 center}to{background-position:200% center}}@keyframes llLegendBurst{0%{transform:translate(-50%,-50%) scale(.4);opacity:1}100%{transform:translate(calc(-50% + var(--dx)),calc(-50% + var(--dy))) scale(1) rotate(200deg);opacity:0}}@media(max-width:650px){.ll-legend-actions{flex-direction:column}.ll-legend-cine{padding:30px 14px 24px}.ll-legend-cine-title{font-size:29px}}
  `;
  /* The original burst only lived for roughly one second. Keep a gentle, looping
     ember layer alive for the whole legendary-result screen instead. */
  style.textContent+=`
 .ll-legend-cine > :not(.ll-legend-particles){position:relative;z-index:1}.ll-legend-particles{z-index:0;overflow:hidden;mix-blend-mode:screen}.ll-legend-particles::before{content:'';position:absolute;left:50%;top:64%;width:210px;height:130px;transform:translate(-50%,-50%);border-radius:50%;background:radial-gradient(ellipse,rgba(255,126,36,.17),rgba(232,200,112,.08) 36%,transparent 70%);filter:blur(4px);animation:llLegendFireGlow 2.8s ease-in-out infinite}.ll-legend-particles i{left:var(--x,50%);top:var(--y,76%);width:var(--size,5px);height:var(--size,5px);border-radius:50% 50% 50% 0;background:radial-gradient(circle at 35% 28%,#fff7c8 0 15%,#ffd15c 33%,var(--ember,#ff6b35) 68%,rgba(255,79,35,0) 72%);box-shadow:0 0 calc(var(--size,5px) * 1.8) var(--ember,#ff6b35),0 0 14px rgba(255,188,74,.65);opacity:0;will-change:transform,opacity;animation:llLegendEmberRise var(--duration,2.4s) cubic-bezier(.18,.72,.34,1) var(--delay,0s) infinite!important}@keyframes llLegendEmberRise{0%,7%{opacity:0;transform:translate(-50%,-50%) scale(.2) rotate(0)}13%{opacity:.98}55%{opacity:.72}100%{opacity:0;transform:translate(calc(-50% + var(--dx)),calc(-50% + var(--dy))) scale(.72) rotate(155deg)}}@keyframes llLegendFireGlow{0%,100%{opacity:.45;transform:translate(-50%,-50%) scale(.92)}50%{opacity:.95;transform:translate(-50%,-50%) scale(1.12)}}
 .ll-legend-banner{isolation:isolate}.ll-legend-banner>.ll-legend-banner-embers{position:absolute;inset:0;z-index:0;overflow:hidden;pointer-events:none}.ll-legend-banner>.ll-legend-banner-embers i{position:absolute;left:var(--x);bottom:-12px;width:var(--size);height:calc(var(--size) * 1.45);border-radius:50% 50% 50% 0;background:radial-gradient(circle at 35% 25%,#fff8cf 0 15%,#ffd15c 34%,#ff743d 65%,rgba(255,79,35,0) 75%);box-shadow:0 0 10px rgba(255,132,57,.9);opacity:0;will-change:transform,opacity;animation:llLegendBannerEmber var(--duration) linear var(--delay) infinite}@keyframes llLegendBannerEmber{0%{opacity:0;transform:translateX(-50%) translateY(0) scale(.4)}10%{opacity:.92}63%{opacity:.7}100%{opacity:0;transform:translateX(calc(-50% + var(--dx))) translateY(var(--dy)) scale(.2) rotate(150deg)}}@media(prefers-reduced-motion:reduce){.ll-legend-banner>.ll-legend-banner-embers i{animation:none;opacity:.42;transform:translateX(-50%) translateY(-42px)}}
   `;
   style.textContent+=`
    /* This is scoped to the 12-word Legend Call quiz only. */
    .ll-legend-quiz-theme .ll-panel{position:relative;isolation:isolate;overflow:hidden;border-color:rgba(218,184,86,.62);background:radial-gradient(circle at 86% 7%,rgba(220,184,80,.17),transparent 30%),radial-gradient(circle at 10% 104%,rgba(113,53,205,.28),transparent 42%),linear-gradient(145deg,#151024,#29153c 56%,#11141d);box-shadow:0 24px 62px rgba(22,10,55,.48),inset 0 0 42px rgba(190,151,255,.07)}
    .ll-legend-quiz-theme .ll-panel:before{content:'';position:absolute;inset:-42%;z-index:0;background:repeating-conic-gradient(from 28deg at 50% 107%,rgba(226,193,95,.10) 0deg 1deg,transparent 1.8deg 15deg);opacity:.58;animation:llLegendQuizRays 20s linear infinite}
    .ll-legend-quiz-theme .ll-panel:after{content:'';position:absolute;left:-12%;right:-12%;bottom:-20px;height:128px;z-index:0;background:radial-gradient(ellipse at 20% 100%,rgba(104,53,214,.3),transparent 40%),radial-gradient(ellipse at 52% 96%,rgba(232,200,112,.18),transparent 34%),radial-gradient(ellipse at 85% 100%,rgba(92,42,180,.26),transparent 42%);filter:blur(8px);animation:llLegendQuizGlow 3.1s ease-in-out infinite}
    .ll-legend-quiz-theme .ll-panel>*{position:relative;z-index:1}
    .ll-legend-quiz-theme .ll-topbar{border-bottom-color:rgba(232,200,112,.18)}
    .ll-legend-quiz-theme .ll-title em{color:#e8c870;text-shadow:0 0 16px rgba(232,200,112,.42)}
    .ll-legend-quiz-theme .ll-stars{color:#f6df9a}
    .ll-legend-quiz-theme .ll-progress{background:rgba(223,197,115,.13)}
    .ll-legend-quiz-theme .ll-progress>div{background:linear-gradient(90deg,#7c3aed,#c9a84c,#fff0b5);box-shadow:0 0 14px rgba(201,168,76,.52)}
    .ll-legend-quiz-theme .ll-question{border-color:rgba(201,168,76,.44);background:linear-gradient(145deg,rgba(51,28,78,.62),rgba(18,19,31,.78));box-shadow:inset 0 0 30px rgba(201,168,76,.05)}
    .ll-legend-quiz-theme .ll-question-word,.ll-legend-quiz-theme .ll-answer{color:#f9ebc8}
    .ll-legend-quiz-theme .ll-position{color:#d9bd76}
    .ll-legend-quiz-theme .ll-btn.primary{background:linear-gradient(135deg,#6d35cb,#c9a84c)!important;border-color:rgba(255,237,178,.4)!important;color:#fff9e9!important}
    .ll-legend-quiz-theme .ll-btn.danger{border-color:rgba(183,135,255,.35)!important;background:rgba(38,22,67,.52)!important}
    @keyframes llLegendQuizRays{to{transform:rotate(1turn)}}
    @keyframes llLegendQuizGlow{0%,100%{opacity:.58;transform:translateY(0) scale(.94)}50%{opacity:1;transform:translateY(-7px) scale(1.06)}}
    @media(prefers-reduced-motion:reduce){.ll-legend-quiz-theme .ll-panel:before,.ll-legend-quiz-theme .ll-panel:after{animation:none}}
   `;
...
function decorateDashboard(){
  ...
  const banner=root.querySelector('[data-legend-call]');if(banner&&!banner.querySelector('.ll-legend-banner-embers')){const embers=document.createElement('div');embers.className='ll-legend-banner-embers';embers.setAttribute('aria-hidden','true');banner.prepend(embers);setTimeout(spawnBannerEmbers,20);}
...
function quizWordHtml(event){
  ...
  llArea().querySelector('.ll-shell.ll-quiz-card')?.classList.add('ll-legend-quiz-theme');
...
function spawnParticles(){
  ...
  const count=outcome.kind==='virtualGoal'?34:outcome.kind==='diceMax'&&outcome.amount===3?28:22,colors=['#ff5a36','#ff7a22','#ffd15c','#e8c870'];for(let i=0;i<count;i++){const p=document.createElement('i'),side=(Math.random()-.5)*2,up=92+Math.random()*176;p.style.setProperty('--x',(50+(Math.random()-.5)*38)+'%');p.style.setProperty('--y',(72+Math.random()*18)+'%');p.style.setProperty('--dx',(side*(68+Math.random()*128))+'px');p.style.setProperty('--dy',(-up)+'px');p.style.setProperty('--size',(3+Math.random()*5).toFixed(1)+'px');p.style.setProperty('--ember',colors[i%colors.length]);p.style.setProperty('--duration',(1.8+Math.random()*1.8).toFixed(2)+'s');p.style.setProperty('--delay',(-Math.random()*3.4).toFixed(2)+'s');host.appendChild(p);}
}
function spawnBannerEmbers(){
  if(typeof document==='undefined')return;document.querySelectorAll('.ll-legend-banner-embers').forEach(host=>{if(host.dataset.embersReady==='1')return;host.dataset.embersReady='1';for(let i=0;i<20;i++){const p=document.createElement('i');p.style.setProperty('--x',(3+Math.random()*94)+'%');p.style.setProperty('--dx',((Math.random()-.5)*110)+'px');p.style.setProperty('--dy',(-(115+Math.random()*105))+'px');p.style.setProperty('--size',(2.5+Math.random()*3.5).toFixed(1)+'px');p.style.setProperty('--duration',(1.6+Math.random()*1.8).toFixed(2)+'s');p.style.setProperty('--delay',(-Math.random()*3.1).toFixed(2)+'s');host.appendChild(p);}});
}
