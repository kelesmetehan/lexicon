...
assert(html.includes('league-v2.js?v=20260721-3')&&html.includes('save-backup-hardening.js?v=20260721-1')&&html.includes('manager-market.js?v=20260719-1'),'Script cache versions must be updated.');
...
console.log('Presentation flows: 23 checks passed.');